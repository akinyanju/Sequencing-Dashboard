...
This diagram shows how the main scripts and modules interact in the Genome Technologies sequencing and QC metrics system. *Raw flowchart is located at images/flowchart.txt for future edit and was plotted at https://www.plantuml.com*.
...
* **server.R**
  ...
  * If working in development mode on your personal computer, search for "DEV MODE: show debug code only" and uncomment that block. Then, search for 'PRODUCTION MODE: actually email the code' and comment that block. **Never forget to reverse these changes when code is moved to proudction server** 
